...
graph_options = ["Histograma dos 10 jogos com mais reviews","Histograma de sentimentos","Histograma de contagem de reviews recomendados por sentimento","Gráfico de pizza de distribuição de sentimentos"]
...
elif selected_chart == "Histograma de sentimentos":
